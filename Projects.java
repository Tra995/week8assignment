...
public class Projects {
	...
	private void addStepToCurrentProject() {
		...
		if(Objects.nonNull(stepText)) {
			...
			projectsService.addStep(step);
			curProject = projectsService.fetchProjectById(step.getProjectId());
		}
	...
	private void addMaterialToCurrentProject() {
		...
		if(Objects.nonNull(materialName)) {
			...
			projectsService.addMaterialToProject(material);
			curProject = projectsService.fetchProjectById(material.getProjectId());
		}
